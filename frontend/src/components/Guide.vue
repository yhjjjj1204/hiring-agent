...
import Page14 from './guide/Page14.vue'
...
const slides = [
  // --- Phase 1: Background & Big Picture ---
  {
  ...
  },
  {
    ...
    subtitle: "Runtime Architecture Overview",
    content: "Our optimized 5-tier architecture separates concerns between Client interactions, a Reactive Gateway, Hardened Security, the AI Pipeline, and a Hybrid Storage foundation. This ensures high performance, security, and scalability for real-time recruitment workflows.",
    icon: Layers,
    color: "var(--ok)",
    component: Page03
  },

  // --- Phase 2: The Submission & Interaction Flow ---
  {
  ...
  },
  {
    ...
    subtitle: "Blind Screening & Redaction",
    content: "We eliminate unconscious bias by automatically redacting PII (Names, Emails, Photos) and identity markers from candidate data before evaluation. This ensures that the competing experts judge candidates solely on verified professional impact.",
    icon: EyeOff,
    color: "var(--ok)",
    component: Page07
  },
  ...
  // --- Phase 3: Internal Mechanisms & Operations ---
  {
...
.is-printing-active :deep(.blind-visual),
.is-printing-active :deep(.auth-visual),
.is-printing-active :deep(.chatbot-visual),
.is-printing-active :deep(.usage-visual),
.is-printing-active :deep(.resume-mgmt-visual),
.is-printing-active :deep(.extraction-visual),
.is-printing-active :deep(.arch-visual-v3) {
